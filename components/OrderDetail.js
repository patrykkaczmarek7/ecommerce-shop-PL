            ...
            <div key={order._id} style={{margin: '20px auto'}} className="row justify-content-around">
                ...
                <div className="text-uppercase my-3" style={{maxWidth: '600px'}}>
                    ...
                    <div className="mt-4 text-secondary">
                        <h3>Dostawa</h3>
                        <p>Imię i nazwisko: {order.user.name}</p>
                        ...
                        <h3>Płatność</h3>
                        {
                            order.method && <h6>Metoda płatności: <em>{order.method}</em></h6>
                        }
                        
                        {
                            order.paymentId && <p>ID płatności: <em>{order.paymentId}</em></p>
                        }
                            ...
                            
                {
                    ...
                    <div className="p-4">
                        <h2 className="mb-4 text-uppercase">Suma: ${order.total}</h2>
