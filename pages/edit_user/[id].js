        ...
        <div className="profile_page edit_user my-3">
            ...
            <div>
                <button className="btn btn-dark" onClick={() => router.back()}>
                    <i className="fas fa-long-arrow-alt-left" aria-hidden></i> Wróć
                </button>
            </div>

            <div className="col-md-4 mx-auto my-4">
                <h2 className="text-uppercase text-secondary">Użytkownik</h2>

                <div className="form-group">
                    <label htmlFor="name" className="d-block">Imię i nazwisko</label>
                ...
                <button className="btn btn-dark" onClick={handleSubmit}>Zaktualizuj</button>
